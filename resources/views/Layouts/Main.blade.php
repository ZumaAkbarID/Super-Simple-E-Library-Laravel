...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item @if (Route::currentRouteName() == 'Pinjam') active @endif">
                <a class="nav-link" href="{{ route('Pinjam') }}">
                    <i class="fas fa-fw fa-bookmark"></i>
                    <span>Buat Pinjaman</span></a>
            </li>

            <!-- Nav Item - Charts -->
            <li class="nav-item @if (Route::currentRouteName() == 'Account') active @endif">
                <a class="nav-link" href="{{ route('Account') }}">
                    <i class="fas fa-fw fa-users"></i>
                    @if ($user->role == 'Admin')
                        <span>Anggota & Petugas</span>
                    @else
                        <span>Anggota</span>
                    @endif
                </a>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item @if (Route::currentRouteName() == 'Buku') active @endif">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Perpustakaan {{ config('app.name') . ' ' . date('Y') }}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Apakah Anda yakin akan logout sekarang? pastikan data sudah tersimpan dengan
                    baik.</div>
